          ...
          <div className="text-center">
            ...
            <div className="flex gap-4 justify-center pt-4">
              ...
              <a
                ...
                className="inline-flex items-center px-6 py-3 border-2 border-[#0a0a23] font-medium rounded-lg transition-colors duration-200 text-[#0a0a23] no-underline hover:bg-[#0a0a23] hover:text-[#ffffff]"
              >
                View GitHub
              </a>
            </div>
